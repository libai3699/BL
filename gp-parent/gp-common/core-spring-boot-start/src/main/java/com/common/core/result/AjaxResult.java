...
public class AjaxResult extends HashMap<String, Object>
{
    ...
    {
        String messages = MessagesUtils.get("user.operate.successfully");
        return AjaxResult.successMsg(messages);
    }
    ...
    {
        String messages = MessagesUtils.get("user.operate.successfully");
        return AjaxResult.success(messages, data);
    }
    ...
    {
        String messages = MessagesUtils.get("user.operate.failure");
