...
public class BeanCopier {
     ...
     * @return
     */
    public static Map<String, Object> classToMap(Class clazz, Object object, boolean ignoreNull) {
     ...
     */
    public static <T> T convertMapToClass(Class<T> clazz, Map<String, Object> map) {
        T bean = null;
        try {
