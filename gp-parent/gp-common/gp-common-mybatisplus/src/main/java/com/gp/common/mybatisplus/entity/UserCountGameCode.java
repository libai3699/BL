...
/**
 * 用户游戏类型打码量统计对象 t_user_count_game_code
 *
 * @author axing
 * @date 2025-06-23
 */
@ApiModel("用户游戏类型打码量统计")
@Data
@NoArgsConstructor
@AllArgsConstructor
@TableName("t_user_count_game_code")
public class UserCountGameCode extends BaseEntity {
    private static final long serialVersionUID = 1L;
    public static final String REDIS_KEY = "msg:UserCountGameCode";
