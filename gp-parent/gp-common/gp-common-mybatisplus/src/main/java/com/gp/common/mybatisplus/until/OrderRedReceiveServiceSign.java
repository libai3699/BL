...
@Component
public class OrderRedReceiveServiceSign {
    @Resource
    private MNacosParam mNacosParam;
    @Resource
    private TelegramUtil telegramUtil;
    public void dealSign(OrderRedReceive one) {
    ...
    private String getParam(OrderRedReceive one) {
    ...
    public void checkSign(OrderRedReceive one) {
    ...
    public Boolean checkSignFlag(OrderRedReceive one) {
