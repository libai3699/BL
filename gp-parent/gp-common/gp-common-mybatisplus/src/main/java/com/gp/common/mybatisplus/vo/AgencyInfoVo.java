...
public class AgencyInfoVo implements Serializable {
    ...
    @ApiModelProperty(value = "代理基本信息")
    private AgencyInfoDetailVo agencyInfoDetailVo;

    @ApiModelProperty(value = "代理数据信息")
    private AgencyInfoDataVo agencyInfoDataVo;
    ...
    @ApiModel(description="代理基本信息")
    @Data
    public static class AgencyInfoDetailVo{
        @ApiModelProperty(value = "代理代理商ID")
        ...
        @ApiModelProperty(value = "代理链接web")
        private String inviteUrlWeb;
        @ApiModelProperty(value = "代理链接tg")
        private String inviteUrlTg;
    }
    @ApiModel(description="代理数据信息")
    @Data
    public static class AgencyInfoDataVo{
        @ApiModelProperty(value = "用户总数量")
        private Integer totalUserNum;       // 用户总数量
        @ApiModelProperty(value = "今日新增用户数量")
        private Integer todayUserNum;       // 用户总数量
       ...
       @ApiModelProperty(value = "有效人数", example = "0")
        private Integer todayAvailableNum;    // 当月亏损
