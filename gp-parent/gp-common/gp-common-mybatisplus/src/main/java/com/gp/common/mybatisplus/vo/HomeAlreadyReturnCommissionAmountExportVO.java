...
@Data
@ApiModel("首页已返佣导出")
public class HomeAlreadyReturnCommissionAmountExportVO implements Serializable {
    ...
    @ApiModelProperty("已返佣金额")
    @Excel(name = "已返佣金额", cellType = Excel.ColumnType.NUMERIC)
