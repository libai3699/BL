...
public class RestTemplateUtils {
     ...
     * @return
     */
    public <T> ResponseEntity<T> upload(File file, String uploadUrl, Class<T> responseType) throws RestClientException {
        if (!file.exists()) {
            return null;
        }
        //将文件传入文件管理系统
        ...
        ResponseEntity<T> pathEntity = restTemplate.postForEntity(uploadUrl, param, responseType);
        //删除本地文件
        file.delete();
