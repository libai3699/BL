...
import com.gp.common.utils.http.HttpHelper;
import com.gp.framework.interceptor.annotation.RepeatSubmit;
...
public class RepeatSubmitInterceptor extends HandlerInterceptorAdapter
{
    ...
    @Autowired
    private BackRedisCache redisCache;
    ...
    public boolean isRepeatSubmit(HttpServletRequest request, RepeatSubmit annotation) {
        ...
        JsonXssRequestWrapper repeatedlyRequest = (JsonXssRequestWrapper) request;
