...
public class BaseController
{
    ...
    private boolean isValidOrderByColumn(String orderByColumn) {
        List<String> allowedColumns = Arrays.asList(
                ...
                ,"channelRebate", "betAmount", "win", "winLoss", "codeAmount", "rebate", "superRebate","waitRebateAmount","waitReturnCommissionAmount"
                ,"alreadyRebateAmount","alreadyReturnCommissionAmount"
        );
