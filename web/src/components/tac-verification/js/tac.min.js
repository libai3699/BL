(() => {
              ...
              return function (t) {
                ...
                return n && t
                  ? t.split(',').map(function (t) {
                      ...
                      return i(
                        e.replace(a, ''.concat(t.replace(/{fileName}/g, n), '.css'))
                      );
                    })
                  : [e.replace('.js', '.css')];
              };
      ...
      687: (t, e, a) => {
        ...
        function s(t, e) {
          ...
          (s.push({
            ...
            (t.__m__ = c.bind(null, t)),
            (t.__u__ = d.bind(null, t)),
            window.addEventListener('mousemove', t.__m__),
            window.addEventListener('mouseup', t.__u__),
            window.addEventListener('touchmove', t.__m__, !1),
            window.addEventListener('touchend', t.__u__, !1),
            t && t.doDown && t.doDown(e, t));
        }
        function c(t, e) {
          ...
          (h.push(u),
            l < 0 ? (l = 0) : l > d && (l = d),
            (t.currentCaptchaData.moveX = l),
            (t.currentCaptchaData.moveY = p),
            t.doMove && t.doMove(e, t));
        }
        function o(t) {
          t &&
            (t.__m__ &&
              (window.removeEventListener('mousemove', t.__m__),
              window.removeEventListener('touchmove', t.__m__)),
            t.__u__ &&
              (window.removeEventListener('mouseup', t.__u__),
              window.removeEventListener('touchend', t.__u__)));
        }
        function d(t, e) {
          o(t);
          const a = r(e);
          ...
          const i = t.currentCaptchaData.startTime,
            ...
            s = { x: a.x, y: a.y, type: 'up', t: new Date().getTime() - i.getTime() };
        ...
        function l(t, e) {
          (f(t).find('#tianai-captcha-tips').removeClass('tianai-captcha-tips-on'),
            e && setTimeout(e, 0.35));
        }
        function p(t, e, a, i) {
          ...
          (n.text(e),
            1 === a
              ? (n.removeClass('tianai-captcha-tips-error'),
                n.addClass('tianai-captcha-tips-success'))
              : (n.removeClass('tianai-captcha-tips-success'),
                n.addClass('tianai-captcha-tips-error')),
            n.addClass('tianai-captcha-tips-on'),
            setTimeout(i, 1e3));
        }
        class u {
          showTips(t, e, a) {
        ...
        class m {
          ...
          on(t, e) {
            return (this.getTarget().addEventListener(t, e, { passive: !0 }), this);
          }
          width() {
        ...
        const v = class extends u {
          ...
          init(t, e, a) {
            return (
              ...
              this.el
                ...
                .mousedown(s.bind(null, this)),
              this.el
                .find('#tianai-captcha-slider-move-btn')
                .touchstart(s.bind(null, this)),
          ...
          loadStyle() {
            ...
            (i &&
              ((t = i.btnUrl),
              (a = i.moveTrackMaskBgColor),
              (e = i.moveTrackMaskBorderColor)),
              this.el
          ...
          loadCaptchaForData(t, e) {
            ...
            (a.attr('src', e.data.backgroundImage),
              i.attr('src', e.data.templateImage),
              a.on('load', () => {
                ((t.currentCaptchaData = h(
                  a.width(),
                  a.height(),
                  i.width(),
                  i.height(),
                  ...
                  (t.currentCaptchaData.currentCaptchaId = e.data.id));
              }));
          }
        };
        a(305);
          ...
          doMove() {
            ...
            (this.el
              ...
              this.el
                ...
                .css(
                  'transform',
                  'rotate(' + t / (this.currentCaptchaData.end / 360) + 'deg)'
                ),
              this.el
                .find('#tianai-captcha-slider-move-track-mask')
                .css('width', t + 'px'));
        ...
        const b = class extends u {
          ...
          loadCaptchaForData(t, e) {
            ...
            (a.css('background-image', 'url(' + e.data.backgroundImage + ')'),
              i.css('background-image', 'url(' + e.data.backgroundImage + ')'),
        ...
        class E {
          constructor(t) {
            ...
            ((this.bindEl = t.bindEl),
              ...
              (this.requestChain = []),
              (this.timeToTimestamp = t.timeToTimestamp || !0),
          ...
          validCaptcha(t, e, a, i) {
            const n = { id: t, data: e };
            let r = {};
            ((r.headers = this.requestHeaders || {}),
              (r.data = n),
              (r.headers['Content-Type'] = 'application/json;charset=UTF-8'),
              (r.method = 'POST'),
              (r.url = this.validCaptchaUrl),
              this._preRequest('validCaptcha', r, a, i));
            return this.doSendRequest(r)
              .then((t) => (this._postRequest('validCaptcha', r, t, a, i), t))
              .then((t) => {
                if (200 == t.code) {
        ...
        ((window.TAC = class {
          ...
          destroyWindow() {
            (this.C && (this.C.destroy(), (this.C = void 0)),
              this.domTemplate && this.domTemplate.remove());
          }
          openCaptcha() {
            setTimeout(() => {
            ...
            this.config.requestCaptchaData().then((t) => {
              ...
              (a.init(t, (t, e) => {
                ...
                (('ROTATE_DEGREE' !== e.type && 'ROTATE' !== e.type) ||
                  ...
                  a.data && (i.data = a.data));
                const n = e.currentCaptchaData.currentCaptchaId;
                ((e.currentCaptchaData = void 0),
                  this.config.validCaptcha(n, i, e, this));
              }),
                (this.C = a),
                this.openCaptcha());
            });
  ...
  function n(t) {
    ...
    var r = (i[t] = { id: t, exports: {} });
    try {
      var s = { id: t, module: r, factory: a[t], require: n };
      (n.i.forEach(function (t) {
        t(s);
      }),
        (r = s.module),
        s.factory.call(r.exports, r, r.exports, s.require));
    } catch (t) {
      throw ((r.error = t), t);
    }
    return r.exports;
  ...
  ((n.m = a),
    (n.c = i),
    (n.i = []),
    (n.hu = (t) => t + '.' + n.h() + '.hot-update.js'),
    (n.miniCssF = (t) => {}),
    (n.hmrF = () => 'main.' + n.h() + '.hot-update.json'),
    (n.h = () => '45e3837e3116285a06d5'),
    (n.g = (function () {
    ...
    (n.l = (a, i, r, s) => {
      if (t[a]) t[a].push(i);
        ...
        if (void 0 !== r)
          for (
            var d = document.getElementsByTagName('script'), h = 0;
            h < d.length;
            h++
          ) {
            var l = d[h];
        ...
        (c ||
          ...
          c.setAttribute('data-webpack', e + r),
          (c.src = a)),
          (t[a] = [i]));
        var p = (e, i) => {
          ...
          u = setTimeout(p.bind(null, void 0, { type: 'timeout', target: c }), 12e4);
            ...
            return a
              ? l('prepare').then(function () {
                  ...
                  return (
                    (e = []),
                    Promise.all(
                      Object.keys(n.hmrC).reduce(function (t, r) {
      ...
      function f(t) {
        return 'ready' !== o
          ? Promise.resolve().then(function () {
              throw new Error(
                'apply() is only allowed in ready status (state: ' + o + ')'
              );
            })
          : m(t);
      }
            ...
            y = (function (e, a) {
              ...
              var n = function (n) {
                  if (i.hot.active) {
                    ...
                    -1 === i.children.indexOf(n) && i.children.push(n);
                  } else s = [];
                  return e(n);
                },
                c = function (t) {
              ...
              accept: function (t, e, a) {
                if (void 0 === t) b._selfAccepted = !0;
                  ...
                  for (var i = 0; i < t.length; i++)
                    ((b._acceptedDependencies[t[i]] = e || function () {}),
                      (b._acceptedErrorHandlers[t[i]] = a));
                else
                  ((b._acceptedDependencies[t] = e || function () {}),
                    (b._acceptedErrorHandlers[t] = a));
              },
              decline: function (t) {
    ...
    (() => {
      if ('undefined' != typeof document) {
        var t = (t, e, a, i, n) => {
          ...
          e = (t, e) => {
            for (
              var a = document.getElementsByTagName('link'), i = 0;
              i < a.length;
              i++
            ) {
    ...
    (() => {
      var t,
        ...
        i,
        r,
        s = (n.hmrS_jsonp = n.hmrS_jsonp || { 179: 0 }),
        c = {};
      function o(e, a) {
        return (
          (t = a),
          new Promise((t, a) => {
            ...
            n.l(i, (t) => {
              if (c[e]) {
                ...
                ((r.message =
                  'Loading hot update chunk ' + e + ' failed.\n(' + i + ': ' + n + ')'),
        ...
        function c(t) {
          for (
            ...
            if (d && (!d.hot._selfAccepted || d.hot._selfInvalidated)) {
              ...
              if (d.hot._main) return { type: 'unaccepted', chain: c, moduleId: s };
        ...
        for (var u in a)
          if (n.o(a, u)) {
            var f,
              ...
              C = '';
            switch (
              ((f = m ? c(u) : { type: 'disposed', moduleId: u }).chain &&
                (C = '\nUpdate propagation: ' + f.chain.join(' -> ')),
              f.type)
            ) {
              case 'self-declined':
                (t.onDeclined && t.onDeclined(f),
                  t.ignoreDeclined ||
                    (v = new Error(
                      'Aborted because of self decline: ' + f.moduleId + C
                    )));
                break;
              case 'declined':
                (t.onDeclined && t.onDeclined(f),
                ...
                break;
              case 'unaccepted':
                (t.onUnaccepted && t.onUnaccepted(f),
                  t.ignoreUnaccepted ||
                    (v = new Error('Aborted because ' + u + ' is not accepted' + C)));
                break;
              case 'accepted':
            ...
            if (v) return { error: v };
            if (g)
              for (u in ((l[u] = m), o(h, f.outdatedModules), f.outdatedDependencies))
                n.o(f.outdatedDependencies, u) &&
                  (d[u] || (d[u] = []), o(d[u], f.outdatedDependencies[u]));
          ...
          dispose: function () {
            ...
            for (var e, a = h.slice(); a.length > 0; ) {
              ...
              if (c) {
                ...
                for (
                  n.hmrD[r] = o, c.hot.active = !1, delete n.c[r], delete d[r], k = 0;
                  k < c.children.length;
                  k++
                ) {
                  ...
                  for (var b = 0; b < o.length; b++)
                    try {
                      ...
                      if ('function' == typeof p[b])
                        try {
                          p[b](a, { moduleId: s, dependencyId: u[b] });
                        } catch (i) {
                          (t.onErrored &&
                            t.onErrored({
            ...
            for (var C = 0; C < w.length; C++) {
              ...
              try {
                ...
                if ('function' == typeof k.errorHandler)
                  try {
                    k.errorHandler(a, { moduleId: E, module: n.c[E] });
                  } catch (i) {
                    (t.onErrored &&
                      t.onErrored({
                  ...
                  (t.onErrored &&
                    t.onErrored({ type: 'self-accept-errored', moduleId: E, error: a }),
                    t.ignoreErrored || e(a));
              }
            }
            return h;
